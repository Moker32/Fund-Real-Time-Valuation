...
- commodities_watchlist: 自选管理 (CRUD)
...
# 导入所有子模块路由
from . import commodities_data, commodities_watchlist
...
router.include_router(commodities_watchlist.router)

__all__ = ["router", "commodities_data", "commodities_watchlist"]
